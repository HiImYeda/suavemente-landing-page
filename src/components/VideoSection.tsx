        ...
        {videoUrls.length > 0 ? (
          <div className="relative">
            ...
            >
                  ...
                  return (
                    <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                      <div className="group relative">
                        <div className="aspect-video rounded-xl overflow-hidden bg-white shadow-xl border border-slate-200 transition-all duration-300 group-hover:shadow-2xl group-hover:scale-105">
                          {videoId ? (
                            <iframe
              ...
              <CarouselPrevious className="bg-white border-slate-300 text-slate-600 hover:bg-slate-50 shadow-lg" />
              <CarouselNext className="bg-white border-slate-300 text-slate-600 hover:bg-slate-50 shadow-lg" />
            </Carousel>
          </div>
        ) : (
